	<form method="POST" id="CalcForm">
		...
		<table class="calc" cellspacing="0">
			...
			<tr>
				<td class="first td50">{$lang.EstimatedFrontRatio} : </td>
				<td class="last">
					<input class='text' name='FrontRatio' size='8' value='{$vars.FrontRatio}'> (%)
				</td>
			</tr>
			<tr>
				<td class="first td50">{$lang.EstimatedBackRatio} : </td>
				<td class="last">
		...
		<table class="results" cellspacing="0">
			...
			<tr>
				<td class="first">{$lang.AllowableDebtPayments} : </td>
				<td class="last">{$lang.Currency}{$vars.AllowedDebts}</td>
			</tr>
			<tr class="total last">
