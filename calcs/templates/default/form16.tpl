	<form method="POST" id="CalcForm">
		...
		<table class="results" cellspacing="0">
			...
			<tr>
				...
				<td class="last">{$lang.Currency}{$vars.AmortizationTable->TotalPaymentAmount}</td>
			</tr>
			<tr>
			...
			<tr class="total">
				...
				<td class="last">{$lang.Currency}{$vars.DownPayment}</td>
			</tr>
			<tr class="total">
				<td class="first">{$lang.RequiredDownPayment} : </td>
				<td class="last">{$lang.Currency}{$vars.RequiredDownPayment}</td>
			</tr>
			<tr class="total last">
				<td class="first">{$lang.RequiredIncome} : </td>
				<td class="last">{$lang.Currency}{$vars.RequiredIncome}</td>
			</tr>
		</table>
