	<form method="POST" id="CalcForm">
		...
		<table class="calc" cellspacing="0">
			...
			<tr>
				<td class="chapter" colspan="2">{$lang.MonthsAlreadyPaid}</td>
			</tr>
			<tr>
				<td class="first td50">{$lang.MonthsPaid} : </td>
				<td class="last">
					<input class='text' name='PaidPeriods' size='8' value='{$vars.PaidPeriods}'> ({$lang.Months})
				</td>
			</tr>
		...
		<table class="results" cellspacing="0">
			<tr>
				...
				<td class="last">{$lang.Currency}{$vars.AmortizationTable->TotalInterestPaid}</td>
			</tr>
			<tr>
				<td class="first">{$lang.PrincipalApplied} : </td>
				<td class="last">{$lang.Currency}{$vars.AmortizationTable->TotalPrincipalApplied}</td>
			</tr>

			<tr class="total last">
				<td class="first">{$lang.RemainingBalance} : </td>
				<td class="last">{$lang.Currency}{$vars.AmortizationTable->TotalRemainingBalance}</td>
			</tr>
		</table>
