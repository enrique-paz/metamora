	<form method="POST" id="CalcForm">
		...
		<table class="results" cellspacing="0">
			...
			<tr>
				...
				<td class="td25">{$lang.Currency}{$vars.AveragePeriodPayment}</td>
				<td class="td25 last">{$lang.Currency}{$vars.AveragePeriodPayment2}</td>
			</tr>
			<tr>
				<td class="first">{$lang.MonthsPaid} : </td>
				<td class="td25">{$vars.PaidPeriods}</td>
				<td class="td25 last">{$vars.PaidPeriods2}</td>
			</tr>
			<tr class="total">
			...
			<tr>
				...
				<td class="td25 last">{$lang.Currency}{$vars.TotalInterestPaid2}</td>
			</tr>
			<tr class="total">
			...
			<tr>
				<td class="first">{$lang.RemainingBalance} : </td>
				<td class="td25">{$lang.Currency}{$vars.RemainingBalance}</td>
				<td class="td25 last">{$lang.Currency}{$vars.RemainingBalance2}</td>
			</tr>
			<tr class="total">
				<td class="first">{$lang.EquityAppreciation}</td>
				<td class="td25"  align="center">{$lang.Currency}0.00</td>
				<td class="td25 last" align="center">{$lang.Currency}{$vars.TotalPrincipalPaid}</td>
			</tr>			
		</table>

		{if ($vars.ShowTableSel eq 1)}
		<a name="amortization"></a>
		<div class="table-caption schedule">{$lang.InterestOnlyPaymentSchedule}</div>
		...
		<div class="table-caption schedule">{$lang.InterestOnlyWithAdditionalPaymentSchedule}</div>
		<table class="schedule" cellspacing="0">
			<tr>
				<th class="first">{$lang.PeriodNo}</th>
				<th>{$lang.InterestPaid}</th>
