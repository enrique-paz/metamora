...
class Calc
{
	static function PeriodPayment($amount, $interest, $length, $annualPayments = 12, $annualCompounds = 0)
	{
		...
		if ($annualCompounds == 0)
			$annualCompounds = $CalcSettings->CompoundPeriods;
...
//			else
	...
	static function ConsolidateTables($table1, $table2)
	{
...
static function ActualAPR($amount, $closingCost, $interest, $length, $periodPayment)
	{
		if ($amount <= 0)
			return 0;
