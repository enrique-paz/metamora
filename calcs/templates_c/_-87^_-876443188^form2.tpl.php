<?php /* Smarty version 2.6.2, created on 2008-04-09 21:46:19
         compiled from default/form2.tpl */ ?>
	<form method="POST" id="CalcForm">
		<h1><?php echo $this->_tpl_vars['lang']['Calc2Title']; ?>
</h1>
...
'> (<?php echo $this->_tpl_vars['lang']['Years']; ?>
			...
			<tr>
				<td class="chapter" colspan="2"><?php echo $this->_tpl_vars['lang']['MonthsAlreadyPaid']; ?>
</td>
			</tr>
			<tr>
...
'> (<?php echo $this->_tpl_vars['lang']['Months']; ?>
 ...
 : </td>
				<td class="last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AmortizationTable']->TotalInterestPaid; ?>
</td>
			</tr>
			<tr>
				<td class="first"><?php echo $this->_tpl_vars['lang']['PrincipalApplied']; ?>
 : </td>
				<td class="last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AmortizationTable']->TotalPrincipalApplied; ?>
</td>
			</tr>
 ...
 : </td>
				<td class="last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AmortizationTable']->TotalRemainingBalance; ?>
</td>
			</tr>
		</table>
