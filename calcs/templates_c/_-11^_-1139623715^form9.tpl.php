<?php /* Smarty version 2.6.2, created on 2008-05-01 14:05:14
         compiled from default/form9.tpl */ ?>
	<form method="POST" id="CalcForm">
		<h1><?php echo $this->_tpl_vars['lang']['Calc9Title']; ?>
</h1>
...
'> (<?php echo $this->_tpl_vars['lang']['YearsShort']; ?>
			...
			<tr>
				<td class="first td50"><?php echo $this->_tpl_vars['lang']['EstimatedFrontRatio']; ?>
 : </td>
				<td class="last">
...
'> (%)
			...
			<tr>
				<td class="first td50"><?php echo $this->_tpl_vars['lang']['EstimatedBackRatio']; ?>
 : </td>
				<td class="last">
...
%</td>
 ...
 : </td>
			...
			<tr>
				<td class="first"><?php echo $this->_tpl_vars['lang']['AllowableDebtPayments']; ?>
 : </td>
				<td class="last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AllowedDebts']; ?>
</td>
			</tr>
			<tr class="total last">
				<td class="first"><?php echo $this->_tpl_vars['lang']['RequiredIncome']; ?>
 : </td>
				<td class="last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['RequiredIncome']; ?>
</td>
			</tr>
