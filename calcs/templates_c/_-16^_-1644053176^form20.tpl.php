<?php /* Smarty version 2.6.2, created on 2008-05-04 02:01:36
         compiled from default/form20.tpl */ ?>
	<form method="POST" id="CalcForm">
		<h1><?php echo $this->_tpl_vars['lang']['Calc20Title']; ?>
</h1>
...
'> (<?php echo $this->_tpl_vars['lang']['Currency']; ?>
		...
		<table class="results" cellspacing="0">
			<tr class="total">
				<td class="first">&nbsp;</td>
				<td class="td25"><?php echo $this->_tpl_vars['lang']['InterestOnly']; ?>
				...
				<td class="td25 last"><?php echo $this->_tpl_vars['lang']['WithAdditionalPayment']; ?>
 ...
 : </td>
				<td class="td25"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AveragePeriodPayment']; ?>
</td>
				<td class="td25 last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['AveragePeriodPayment2']; ?>
</td>
			</tr>
			<tr>
				<td class="first"><?php echo $this->_tpl_vars['lang']['MonthsPaid']; ?>
 : </td>
				<td class="td25"><?php echo $this->_tpl_vars['vars']['PaidPeriods']; ?>
</td>
				<td class="td25 last"><?php echo $this->_tpl_vars['vars']['PaidPeriods2']; ?>
</td>
			</tr>
			<tr class="total">
 ...
 : </td>
				...
				<td class="td25 last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['TotalInterestPaid2']; ?>
</td>
			</tr>
			<tr class="total">
 ...
 : </td>
			...
			<tr>
				<td class="first"><?php echo $this->_tpl_vars['lang']['RemainingBalance']; ?>
 : </td>
				<td class="td25"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['RemainingBalance']; ?>
</td>
				<td class="td25 last"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['RemainingBalance2']; ?>
</td>
			</tr>
			<tr class="total">
				<td class="first"><?php echo $this->_tpl_vars['lang']['EquityAppreciation']; ?>
</td>
				<td class="td25"  align="center"><?php echo $this->_tpl_vars['lang']['Currency']; ?>
0.00</td>
				<td class="td25 last" align="center"><?php echo $this->_tpl_vars['lang']['Currency'];  echo $this->_tpl_vars['vars']['TotalPrincipalPaid']; ?>
</td>
			</tr>			
		</table>
		...
		<div class="table-caption schedule"><?php echo $this->_tpl_vars['lang']['InterestOnlyPaymentSchedule']; ?>
</div>
...
<br/><br/></td>
		...
		<div class="table-caption schedule"><?php echo $this->_tpl_vars['lang']['InterestOnlyWithAdditionalPaymentSchedule']; ?>
</div>
		<table class="schedule" cellspacing="0">
			<tr>
				<th class="first"><?php echo $this->_tpl_vars['lang']['PeriodNo']; ?>
